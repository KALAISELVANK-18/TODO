...
function TodoTabView({navigation}:HomeNavigationProps) : React.JSX.Element {
    ...
    return (
        <View>
          ...
          handleStatus={()=>{}}
           ...
           status={(element.status=="Pending")?Status.Pending:(element.status=="InProgress")?Status.InProgress:Status.Completed} 
